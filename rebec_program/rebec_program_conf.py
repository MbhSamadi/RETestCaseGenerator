class rebec_program_conf:
    def __init__(self, rebec_count, max_msgservers_count, max_msgservers_seq, property_length, non_causality_count,causality_count, backwards_count,maximum_method_calls, deadlock_count, deadlock_length, strictly):
        ...
        self.deadlock_length = deadlock_length
